...
*' Germany Nuclear phase-out
    vm_cap.up(t,regi,"tnrs","1") $ (t.val ge 2025 and sameas(regi,"DEU")) = 1e-6;
    vm_cap.lo(t,regi,"tnrs","1") $ (t.val ge 2025 and sameas(regi,"DEU")) = 0;
*' ESC -> no new Nuclear capacity (Italy had a plebiscite for this and Greece should not have any new capacity)
    vm_deltaCap.up(t,regi,"tnrs","1") $ (t.val ge 2020 and sameas(regi,"ESC")) = 0;
*' Neither France, ENC, NEN, ECS, ESW or ECE currently plan to early-retire any of their current fleet until 2050
    vm_capEarlyReti.up(t,regi,"tnrs") $ (t.val le 2050 and sameas(regi,"FRA")) = 1e-3;
    vm_capEarlyReti.up(t,regi,"tnrs") $ (t.val le 2050 and sameas(regi,"ENC")) = 1e-3;
    vm_capEarlyReti.up(t,regi,"tnrs") $ (t.val le 2050 and sameas(regi,"NEN")) = 1e-3;
    vm_capEarlyReti.up(t,regi,"tnrs") $ (t.val le 2050 and sameas(regi,"ECS")) = 1e-3;
    vm_capEarlyReti.up(t,regi,"tnrs") $ (t.val le 2050 and sameas(regi,"ESW")) = 1e-3;
    vm_capEarlyReti.up(t,regi,"tnrs") $ (t.val le 2050 and sameas(regi,"ECE")) = 1e-3;
$ENDIF.NucRegiPol  

$IFTHEN.proNucRegiPol not "%cm_proNucRegiPol%" == "off" 
*' Extended nuclear policies: pro-nuclear countries tend to keep nuclear production for political rather than economic reasons.
*' Assuming France keeps at least 80% of its 2025 nuclear capacity in the future.
    vm_cap.lo(t,regi,"tnrs","1") $ (t.val >= 2030 and sameas(regi,"FRA")) = 0.8 * pm_NuclearConstraint("2025",regi,"tnrs");
*' Assuming Czech Republic would keep at least its 2015 nuclear capacity in the future (CZE corresponds to 61.8% of nuclear capacity of ECE in 2015)
    vm_cap.lo(t,regi,"tnrs","1") $ (t.val >= 2030 and sameas(regi,"ECE")) = 0.618 * pm_NuclearConstraint("2015",regi,"tnrs");
*' Assuming Finland would keep at least its 2015 nuclear capacity in the future (FIN corresponds to 21.6% of nuclear capacity of ENC in 2015)
    vm_cap.lo(t,regi,"tnrs","1") $ (t.val >= 2030 and sameas(regi,"ENC")) = 0.216 * pm_NuclearConstraint("2015",regi,"tnrs");
*' Assuming Romania would keep at least its 2015 nuclear capacity in the future (ROU corresponds to 22.1% of nuclear capacity of ECS in 2015)
    vm_cap.lo(t,regi,"tnrs","1") $ (t.val >= 2030 and sameas(regi,"ECS")) = 0.221 * pm_NuclearConstraint("2015",regi,"tnrs");
$ENDIF.proNucRegiPol 
